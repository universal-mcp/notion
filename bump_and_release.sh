...
echo "Generating tools README for src/universal_mcp_notion/app.py..."
universal_mcp readme src/universal_mcp_notion/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_notion/README.md
