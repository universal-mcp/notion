...
This repository contains an implementation of an Notion Universal MCP (Model Context Protocol) server. It provides a standardized interface for interacting with Notion's tools and services through a unified API.
...
You can start using Notion directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Notion.
...
The full list of available tools is at [./src/universal_mcp_notion/README.md](./src/universal_mcp_notion/README.md)
